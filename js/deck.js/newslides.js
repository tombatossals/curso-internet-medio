...
var PERMANENT_URL_PREFIX = 'http://www3.uji.es/~vrubert/mitja/';
...
function enableSlideFrames(no) {
  ...
  var slide = document.querySelector('article.current');
  if (slide) {
      slide.style['-moz-transform'] = 'none';
  }
